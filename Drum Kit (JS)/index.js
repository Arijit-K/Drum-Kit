...
for (var i = 0; i < len; i++) {
  document.querySelectorAll(".drum")[i].addEventListener("click", function(){
    this.style.color = "#fff"; //this means document.querySelectorAll(".drum")[i] that triggered it
    ...
    console.log(this);                     // <button class="w drum" style="color: rgb(255, 255, 255);">w</button>
